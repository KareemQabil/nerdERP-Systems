 ...
 * Shared component for POS and Sales modules
 *
 * Provides a glassmorphic modal with numeric keypad for manager authorization
 * Used for sensitive actions: void items, apply discounts, price overrides, etc.
 */
...
export function ManagerPinModal({ isOpen, onClose, onAuthorize, request }: ManagerPinModalProps) {
    ...
    const actionLabel = {
        ...
        VOID_ORDER: language === 'ar' ? 'إلغاء الطلب' : 'Void Order',
