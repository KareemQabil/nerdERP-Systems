...
import { selectPOSConfig, selectFeatures, setPOSConfig } from '@/features/pos/slices/configSlice';
...
export function SecuritySection() {
    ...
    const togglePinRequirement = (action: PinRequiredAction) => {
        ...
        const newActions = current.includes(action)
            ...
            : [...current, action];
        dispatch(setPOSConfig({ requirePinFor: newActions }));
    };
                ...
                >
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            onChange={(e) => dispatch(setPOSConfig({ maxDiscountPercent: Number(e.target.value) }))}
                            min={0}
                            max={100}
                            className={cn(
                ...
                >
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            onChange={(e) => dispatch(setPOSConfig({ maxRefundWithoutAuth: e.target.value }))}
                            className={cn(
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            onChange={(e) => dispatch(setPOSConfig({ sessionTimeout: Number(e.target.value) }))}
                            className={cn(
