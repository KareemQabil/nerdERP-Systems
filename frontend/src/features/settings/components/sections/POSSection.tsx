...
export function POSSection() {
    ...
    const toggleOrderType = (type: OrderType) => {
        ...
        const newTypes = current.includes(type)
            ...
            : [...current, type];
        dispatch(setPOSConfig({ enabledOrderTypes: newTypes }));
    };

    const setDefaultOrderType = (type: OrderType) => {
        dispatch(setPOSConfig({ defaultOrderType: type }));
    };
        ...
        <div className="space-y-6">
            ...
            >
                ...
                <FeatureToggle
                    ...
                    onChange={(v) => dispatch(setPOSConfig({ taxIncluded: v }))}
                />
            </SettingsCard>
            ...
            >
                ...
                >
                    <select
                        ...
                        onChange={(e) => dispatch(setPOSConfig({ currencyPosition: e.target.value as 'before' | 'after' }))}
                        className={cn(
                ...
                >
                    <select
                        ...
                        onChange={(e) => dispatch(setPOSConfig({ decimalPlaces: Number(e.target.value) }))}
                        className={cn(
                            'px-3 py-1.5 rounded-lg border text-sm',
                            isDark
                                ? 'bg-slate-700 border-slate-600 text-white'
