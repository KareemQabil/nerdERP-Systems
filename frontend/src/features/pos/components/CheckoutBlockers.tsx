...
export function CheckoutBlockers({ onCheckoutReady }: CheckoutBlockersProps) {
    ...
    const canPartial = useAppSelector(selectCanPartialCheckout);
    const readyItems = useAppSelector(selectReadyItems);
    const pendingItems = useAppSelector(selectPendingKitchenItems);
