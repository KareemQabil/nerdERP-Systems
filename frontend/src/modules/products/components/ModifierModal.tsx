...
import { useCartStore, type ProductInfo, type CartItemModifier } from '@/stores/cart.store';
...
export function ModifierModal({ product, isOpen, onClose }: ModifierModalProps) {
    ...
    const handleAddToCart = useCallback(() => {
        ...
        addItem(product, quantity, cartModifiers, instructions || undefined);
        onClose();
    }, [isValid, selectedModifiers, product, quantity, instructions, addItem, onClose]);
