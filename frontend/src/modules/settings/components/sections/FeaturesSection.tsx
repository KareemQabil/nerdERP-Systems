...
export function FeaturesSection() {
    ...
    const { features, setFeature } = useConfigStore();
        ...
        <div className="space-y-6">
            ...
            >
                <FeatureGroup title={t('features.orderTypes', 'Order Types')}>
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.dineIn', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.takeaway', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.delivery', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.driveThru', v)}
                    />
                </FeatureGroup>
                ...
                <FeatureGroup title={t('features.orderManagement', 'Order Management')}>
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.holdOrders', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.mergeOrders', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.splitOrders', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.transferOrders', v)}
                    />
                </FeatureGroup>
                ...
                <FeatureGroup title={t('features.payments', 'Payments')}>
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.splitPayments', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.partialPayments', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.tipCollection', v)}
                    />
                </FeatureGroup>
                ...
                <FeatureGroup title={t('features.kitchen', 'Kitchen')}>
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.kitchenRouting', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.courseManagement', v)}
                    />
                    <FeatureToggle
                        ...
                        onChange={(v) => setFeature('pos.rushOrders', v)}
                    />
                </FeatureGroup>
            </SettingsCard>
            ...
            >
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('customers.search', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('customers.quickCreate', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('customers.loyaltyProgram', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('customers.storeCredit', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('customers.giftCards', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('customers.reservations', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('customers.feedback', v)}
                />
            </SettingsCard>
            ...
            >
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('inventory.stockTracking', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('inventory.batchTracking', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('inventory.expiryTracking', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('inventory.lowStockAlerts', v)}
                />
            </SettingsCard>
            ...
            >
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('security.managerPin', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('security.shiftManagement', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('security.zatcaCompliance', v)}
                />
            </SettingsCard>
            ...
            >
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('integrations.printers', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('integrations.scales', v)}
                />
                <FeatureToggle
                    ...
                    onChange={(v) => setFeature('integrations.paymentTerminals', v)}
                />
            </SettingsCard>
        </div>
    );
